...
export default function DashboardPage() {
  ...
  // No renderizar NADA hasta tener el usuario completo
  if (!listo || !usuario) {
      ...
      <aside style={s.sidebar}>
        ...
        <div style={s.sidebarBottom}>
          <div style={s.userBadge}>
            <div style={s.userAvatar}>{inicial}</div>
            <div>
...
const s: Record<string, React.CSSProperties> = {
  ...
  navLink: { display: "flex", alignItems: "center", gap: "0.6rem", padding: "0.55rem 0.75rem", borderRadius: 8, color: "var(--muted)", fontSize: "0.88rem", fontWeight: 400, textDecoration: "none" },
